...
## Ransomware: Initial Access to Lateral Movement

## Who this is for
This guide is for students who are new to SOC tooling. It is intentionally step-by-step.

## Scenario in plain English
A phishing-origin endpoint compromise is followed by script execution and lateral movement behavior.
...
3. Select index pattern: ransomware_demo_*
