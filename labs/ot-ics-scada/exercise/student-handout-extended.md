...
## OT/ICS/SCADA Detection Engineering

## Who this is for
This guide is for students who are new to SOC tooling. It is intentionally step-by-step.

## Scenario in plain English
Engineering workstation actions and control protocol writes suggest unauthorized manipulation.
...
3. Select index pattern: ot_demo_*
