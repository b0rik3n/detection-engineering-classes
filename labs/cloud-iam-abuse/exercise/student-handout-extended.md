...
## Cloud IAM Abuse (AWS/GCP/Azure)

## Who this is for
This guide is for students who are new to SOC tooling. It is intentionally step-by-step.

## Scenario in plain English
A compromised cloud identity performs unusual key creation and privilege changes followed by suspicious API activity.
...
3. Select index pattern: cloud_demo_*
